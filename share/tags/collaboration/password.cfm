...
<cfswitch expression="#thisTag.executionMode#">
	<cfcase value="start">
		...
		<cfscript>
		standardAttributes = 'id,value,name,align,fieldParam,label,labelClass,editModes,showModes,allowBreak,viewModes';
	...
	<cfcase value="end">
		...
		<cfscript>
		editModeMarkup = '<input type="password" value="#attributes.value#" name="#attributes.name#" id="#attributes.id#"#attributeList# />';
		previewHiddenModeMarkup = '<input type="hidden" value="#attributes.value#" name="#attributes.name#" id="#attributes.id#"#attributeList# />';
		previewShownModeMarkup = previewHiddenModeMarkup;
		viewModeMarkup = '';
		</cfscript>
