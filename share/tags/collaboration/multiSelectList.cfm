...
<cfswitch expression="#thisTag.executionMode#">
	<cfcase value="start">
		...
		<cfscript>
		standardattributes = 'id,formatter,formatterType,formatterVersion,formatterMask,name,data,innerAttributes,displayField,valueField,label,labelClass,delimiters,selected,fieldParam,showModes,editModes,allowBreak,viewModes';
	...
	<cfcase value="end">
		...
		formElement = formElement & '
			<select name="#attributes.name#" id="#attributes.id#" multiple="true" #attributeList#>';
		formSelection = "";
