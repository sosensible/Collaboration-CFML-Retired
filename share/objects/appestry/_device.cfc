<cfcomponent extends="share.objects.sos.fbo">
	...
	<cffunction name="init" access="public">
		<cfargument name="allow" default="android,blackberry,iPhone,iPod_Touch,iPad,kindle,operaMini,mobile" hint="mobile covers the other devices as able">
	...
	//	writeDump("...device constructor called...");abort();
		...
		if(structKeyExists(CGI,"HTTP_USER_AGENT")){
			...
			if(isDevice('android')){
				...
				VARIABLES.is.android = true;
				if(isDevice('silk')){
					VARIABLES.baseDevice = 'kindle';
					VARIABLES.is.mobile = true;
				}
